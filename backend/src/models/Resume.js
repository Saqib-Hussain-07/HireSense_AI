...
const ResumeSchema = new mongoose.Schema(
  {
    ...
    scoreLabel:      { type: String,   default: 'Generic ATS Score' },
    isJdSpecific:    { type: Boolean,  default: false },
    targetJdId:      { type: mongoose.Schema.Types.ObjectId, ref: 'JobDescription', default: null },
    targetJdTitle:   { type: String,   default: '' },
